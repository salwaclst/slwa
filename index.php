...
if (isset($_GET['search'])) {
    ...
    // Use $search_query in your SQL query to filter results
    $foto = mysqli_query($db, "SELECT * FROM tb_image WHERE image_status = 1 AND image_name LIKE '%$search_query%' ORDER BY image_id DESC LIMIT 8");
} else {
            ...
            <div class="box">
				...
				?>
                    <a href="galeri.php?kat=<?php echo $k['category_id'] ?>">
                        <div class="col-5">
                            <img src="img/gogo.png" width="50px" style="margin-bottom:5px;" />
